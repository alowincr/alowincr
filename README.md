...
Me especializo en la construcción de aplicaciones web modernas, combinando frontend atractivo con backend sólido y bases de datos bien estructuradas.

Actualmente fortalezco mi formación con aprendizaje continuo, proyectos prácticos y programas como **Oracle Next Education (ONE)** y **Alura Latam**, enfocado en seguir creciendo como desarrollador Full Stack.
